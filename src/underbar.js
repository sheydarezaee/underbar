(function() {
  ...
  //if n=== undeifined, return the last element

  _.last = function(array, n) {
    const emptyArray = [];
    return n===undefined ? array[array.length-1] : n===0 ? emptyArray : n > array.length ? array : array.slice(n-1);
  };
  ...
  //output: no return value .. runs iterator function (acts as a for loop or for in loop)
...
//---------------------------------
  ...
  _.uniq = function(array) {
    ...
    _.each(array, function(element) {
      wasFound = _.indexOf(result, element);
  ...
  _.pluck = function(collection, key) {
    ...
    // values into a new array of values. _.pluck() is solved for you
    // as an example of this.
    return _.map(collection, function(item){ //item is each element of the (array collection) which is object
      return item[key];
    });
  };
...
//------------------------------------
  ...
  //   if(String.prototype[functionOrKey]) {
  //     return String.prototype[functionOrKey].apply(collection).split(",");
  //   }
  //   else {
  ...
  //we have a method called functionOrKey
  // need to call that method on each element in the collection
